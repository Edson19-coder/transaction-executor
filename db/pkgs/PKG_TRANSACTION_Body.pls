CREATE OR REPLACE PACKAGE BODY PKG_TRANSACTION AS
    ...
    BEGIN
        OPEN rc FOR
            SELECT ID, ACCOUNT_ID, TYPE, AMOUNT, CURRENCY, DESCRIPTION, STATUS, PROVIDER_TRANSACTION_ID, BALANCE_AFTER, TO_CHAR(CREATED_AT, 'YYYY-MM-DD"T"HH24:MI:SS"Z"') AS CREATED_AT
            FROM T_TRANSACTIONS
